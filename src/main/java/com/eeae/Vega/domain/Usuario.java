...
public class Usuario implements Serializable {
    ...
    @Column(name = "pin_temporal")
    private Integer pinTemporal;
    ...
    public LocalDateTime getPinExpiracion() {
        return pinExpiracion;
    }

    public void setPinExpiracion(LocalDateTime pinExpiracion) {
        this.pinExpiracion = pinExpiracion;
    }
}